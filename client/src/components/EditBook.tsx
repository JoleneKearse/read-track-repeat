...
const EditBook: React.FC<EditBookProps> = ({
  ...
  const [coverImageUrl, setCoverImageUrl] = useState<string>(
    currentBook.cover_img_url || currentBook.coverImageUrl || ""
  );
              ...
              <img
                src={
                  (currentBook.cover_img_url ||
                    currentBook.coverImageUrl) as string
                }
          ...
          <div className="flex justify-center items-center pt-10 pb-8 ml-[2.25rem] md:ml-[4rem]">
            ...
            >
              <img
                ...
                alt=""
                aria-hidden="true"
                className="w-1/3 hover:border-purple-300 hover:border-4 hover:rounded-full"
              />
            </button>
            <button
              type="button"
